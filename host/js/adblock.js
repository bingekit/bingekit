...
(function () {
    //if (location.href.startsWith('edge://') || location.href.startsWith('chrome://') || location.href.startsWith('about:')) {
    //   return; // Never run adblock on internal pages
    //}
    if (window.chrome?.webview !== undefined) {
        try {
            ...
            return; // Bail out if host objects missing or error occurs
        }
            ...
            Object.defineProperty(Element.prototype, 'innerHTML', {
                set: function (value) {
                    ...
                    try {
                        ...
                        if (e.message && e.message.includes("TrustedHTML") && typeof value === 'string') {
                            // Fallback parsing for TrustedHTML enforced environments
                            try {
                                if (window.trustedTypes && window.trustedTypes.defaultPolicy) {
                                    originalInnerHTML.set.call(this, window.trustedTypes.defaultPolicy.createHTML(value));
                                    return;
                                }
                            } catch (err) { }
        ...
        document.write = function (content) {
            ...
            try {
                ...
                if (e.message && e.message.includes("TrustedHTML") && typeof content === 'string' && window.trustedTypes && window.trustedTypes.defaultPolicy) {
                    originalWrite.call(document, window.trustedTypes.defaultPolicy.createHTML(content));
                } else {
                    throw e;
                }
            }
        ...
        document.writeln = function (content) {
            ...
            try {
                ...
                if (e.message && e.message.includes("TrustedHTML") && typeof content === 'string' && window.trustedTypes && window.trustedTypes.defaultPolicy) {
                    originalWriteln.call(document, window.trustedTypes.defaultPolicy.createHTML(content));
                } else {
                    throw e;
                }
            }
