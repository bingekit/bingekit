...
BingeKit maps internal dashboards through the `custom:` prefix.
- `custom:dashboard`
- `custom:settings`
- `custom:discover`

**Example:**
If you want to append a Custom RSS feed widget directly onto the main BingeKit dashboard, you would create a Userscript matching `custom:dashboard` containing JS that locates the container and injects a formatted widget block!
