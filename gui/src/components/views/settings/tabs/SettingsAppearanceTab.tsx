        ...
        <div className="p-5 bg-[color-mix(in_srgb,var(--theme-text-main)_2%,transparent)] border border-[color-mix(in_srgb,var(--theme-border)_50%,transparent)] rounded-2xl space-y-4">
          ...
          <div className="pt-4 mt-6 border-t border-[color-mix(in_srgb,var(--theme-border)_50%,transparent)]">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button onClick={() => setTheme({ mode: 'light', titlebarBg: 'color-mix(in srgb, var(--theme-accent) 85%, var(--theme-main))', sidebarBg: 'color-mix(in srgb, var(--theme-main) 95%, var(--theme-text-main))', mainBg: '#f4f4f5', border: 'color-mix(in srgb, var(--theme-main) 85%, var(--theme-text-main))', accent: '#4c57e6', textMain: '#18181b', textSec: 'color-mix(in srgb, var(--theme-text-main) 55%, var(--theme-main))', urlbarBg: 'var(--theme-titlebar-accent)', urlbarText: 'var(--theme-text-sec)', urlbarIcon: 'var(--theme-sidebar-text)', sidebarText: 'color-mix(in srgb, var(--theme-text-main) 85%, var(--theme-main))', titlebarText: 'color-mix(in srgb, var(--theme-accent) 20%, var(--theme-main))', titlebarTextHover: 'var(--theme-titlebar-accent)', titlebarAccent: '#ffffff', titlebarAlt: 'color-mix(in srgb, var(--theme-titlebar-accent) 95%, var(--theme-text-main))', titlebarAlt2: 'color-mix(in srgb, var(--theme-main) 25%, transparent)' })} className="px-3 py-1.5 text-xs bg-[color-mix(in_srgb,var(--theme-text-main)_8%,transparent)] rounded hover:bg-[color-mix(in_srgb,var(--theme-text-main)_12%,transparent)] transition-colors text-[var(--theme-text-main)] border border-[color-mix(in_srgb,var(--theme-text-main)_15%,transparent)]">Two-Tone Light</button>
            </div>
          </div>
        </div>
